...
import {Identity} from 'models/identity.jsx';

// This will be a single identity.
@observer
class IdentityView extends React.Component {
  constructor(...args) {
    super(...args);

    // FIXME: Need to change this to suit identities stuff.
    this.state = {
      showAllFaces: false,
      frame: 0,
      editMode: false,
...
// props are args after the identity/
export default (props) => <IdentityView store={new Identity(props.id)} />;
